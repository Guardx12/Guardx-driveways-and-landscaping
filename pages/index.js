...
export default function Home() {
  ...
  return (
    <div>
          ...
          <div className="heroGrid">
            <div className="heroCard">
              <div className="heroCopy">
                ...
                <p className="lead">
                  Premium block paving, resin and porcelain paving with clean landscaping finishes.
                  Clear quotes, tidy work, and a process that keeps your home usable.
                </p>
                ...
                <div className="heroCtas">
                  ...
                  <a className="btn" href="#work">See recent work</a>
                  <a className="btn" href="#reviews">Read reviews</a>
                </div>
                ...
                <div style={{ marginTop: 18 }} className="ratingCard" aria-label="Rating summary">
                  ...
                  <div>
                    ...
                    <div className="strip" style={{ marginTop: 10 }}>
                      <span className="logo"><IconGoogle /> Google</span>
                      <span className="logo"><IconFacebook /> Facebook</span>
                      <span className="logo"><IconInstagram /> Instagram</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      {/* Work / Gallery (first, to feel different) */}
      <section id="work" className="section">
        <div className="container">
          <div className="kicker">Recent work</div>
          <h2 className="h2">Driveways and gardens that look finished.</h2>
          <p className="sub">
            A few example project shots: porcelain paving, block paving and landscaping detail.
          </p>

          <div className="gallery" aria-label="Project gallery">
            <div className="frame span7 tall">
              <img src="/images/lawn-modern.jpg" alt="Modern lawn and timber fencing" />
              <div className="cap">Modern garden build — lawn, levels & timber (example)</div>
            </div>
            <div className="frame span5 med">
              <img src="/images/rock-garden.jpg" alt="Rock garden landscaping" />
              <div className="cap">Landscaping detail — stone, planting & curves (example)</div>
            </div>
            <div className="frame span5 med">
              <img src="/images/driveway-aerial.jpg" alt="Driveway aerial view" />
              <div className="cap">Large driveway install — clean lines (example)</div>
            </div>
            <div className="frame span7 short">
              <img src="/images/driveway-gate.jpg" alt="Driveway with gate and paving" />
              <div className="cap">Entrance & edging — kerb appeal that lasts (example)</div>
            </div>
          </div>
        </div>
      </section>

      {/* Services (different layout: cards + process) */}
        ...
        <div className="container">
          ...
          <div className="grid" role="list">
            ...
            <div className="card span12" role="listitem">
              <h3>How it works</h3>
              <p>
                1) Site survey & measure → 2) Clear written quote → 3) Prep & sub-base → 4) Install & edges → 5) Clean handover.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Trust signals (logos + guarantees + assurances) */}
      <section id="trust" className="section">
        <div className="container">
          <div className="kicker">Trust</div>
          <h2 className="h2">Accreditations, insurance and guarantees.</h2>
          <p className="sub">
            Trust signals presented as a clean strip and “proof blocks” (not the same badge grid used on other demos).
          </p>

          <div className="strip" aria-label="Accreditations">
            <span className="logo">Marshalls Register (example)</span>
            <span className="logo">Interlay / APL (example)</span>
            <span className="logo">Public Liability</span>
            <span className="logo">Workmanship Guarantee</span>
            <span className="logo">Waste Carrier (example)</span>
          </div>
      ...
      {/* Reviews (editorial quotes + rating summary) */}
      <section id="reviews" className="section sectionAlt">
        <div className="container">
          ...
          <p className="sub">Example reviews with star ratings and platform indicators.</p>

          <div className="grid" style={{ marginTop: 18 }}>
            <div className="card span7">
              <div className="quote">
                <p>“From the first survey to the final clean-down, the team were spot on. The driveway looks incredible.”</p>
                <footer>
            ...
            <div className="card span5">
              <div className="quote">
                <p>“Tidy, polite and they explained everything. Drainage was done properly and the finish is perfect.”</p>
                <footer>
          ...
          <div className="grid" style={{ marginTop: 18 }}>
            <div className="card span5">
              ...
              <div className="strip" style={{ marginTop: 14 }}>
                ...
                <span className="logo">
                  <IconMap /> Sussex (example)
                </span>
              </div>
              <div className="socialRow">
                <a className="logo" href="#" aria-label="Google"><IconGoogle /> Google</a>
                <a className="logo" href="#" aria-label="Facebook"><IconFacebook /> Facebook</a>
                <a className="logo" href="#" aria-label="Instagram"><IconInstagram /> Instagram</a>
              </div>
            ...
            <div className="card span7">
              ...
              <form onSubmit={onSubmit}>
                ...
                <div className="actions">
                  ...
                  <span className="note">{sent ? "✅ Thanks — your message has been sent." : "We aim to reply within 1 business day."}</span>
                </div>
              </form>
            </div>
          </div>
      ...
      <footer className="footer">
        <div className="container">
          <div className="footerGrid">
            <div>
              <div className="brand">
                <div className="mark" aria-hidden="true"><IconLeaf /></div>
                <div className="brandText">
                  <strong>Greenstone Driveways</strong>
                  <span>Driveways • Landscaping • Patios</span>
                </div>
              ...
              <p className="small" style={{ marginTop: 12 }}>© {year} Greenstone Driveways</p>
            </div>

            <div>
              <p className="small">
                This is a <b>GuardX showroom example website (demo)</b>. No customer data is collected.
      ...
      {/* Sticky conversion bar (different pattern) */}
      <div className="stickyBar" role="region" aria-label="Quick actions">
        <div className="mini">
          <span><b>Free site survey</b> • fixed quote</span>
          <span>•</span>
